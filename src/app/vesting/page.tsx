...
const TABS: { id: Tab; label: string }[] = [
  { id: 'create', label: 'New Schedule (Disabled)' },
...
export default function VestingPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--background)' }}>
      <ToolHero
        category="Containment / Token Distribution"
        title="Lester"
        titleHighlight="Vester"
        subtitle="Inspect historical vesting schedules and replacement readiness. New paid schedules remain disabled during post-compromise containment."
        color={COLOR}
        ...
        stats={[
          ...
          { label: 'Writes', value: 'New schedules disabled' },
      ...
      <div className="tool-page-content" style={{ maxWidth: '920px' }}>
        {!isConnected ? (
          <ConnectWalletPrompt
            body="Connect only to inspect beneficiary schedules or use the existing beneficiary release path. New paid schedule creation remains disabled."
