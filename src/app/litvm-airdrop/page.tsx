...
export const metadata: Metadata = {
  ...
  description: 'The Lester Labs batch distribution utility is not a reward claim. Sending remains disabled until the reviewed replacement contract is activated.',
  ...
  return (
    <main className="min-h-screen bg-[var(--bg)] px-6 py-28 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight sm:text-6xl">Batch sending is temporarily disabled</h1>
        <p className="mt-6 max-w-3xl text-lg leading-8 text-white/55">
          Lester Labs does not operate a LitVM reward programme, snapshot, allocation, eligibility checker, or claim
          page. Local CSV parsing does not enrol a wallet in anything. On-chain sending remains blocked until the new
          bounded Disperse contract and exact runtime are deployed, verified, and source-pinned.
        </p>
        <div className="mt-10 rounded-2xl border border-amber-300/20 bg-amber-300/5 p-6 text-sm leading-6 text-amber-100/75">
          ...
          repeat transactions for eligibility. When reactivated, every batch will be capped at 200 recipient entries,
          displayed before signing, and counted on-chain only after successful execution.
        </div>
        <div className="mt-10 flex flex-wrap gap-3">
          <Link href="/airdrop" className="rounded-lg bg-[#6B4FFF] px-5 py-3 text-sm font-semibold">Open local review tool</Link>
