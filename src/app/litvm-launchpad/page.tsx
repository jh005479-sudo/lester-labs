...
export const metadata: Metadata = {
  ...
  description: 'Legacy Lester Labs ILO contracts are recovery-only. New sale creation, funding, contributions, and finalisation remain disabled.',
  ...
  return (
    <main className="min-h-screen bg-[var(--bg)] px-6 py-28 text-white">
      <div className="mx-auto max-w-4xl">
        <p className="text-xs font-bold uppercase tracking-[0.16em] text-amber-300">Recovery-only service</p>
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight sm:text-6xl">New LitVM presales are disabled</h1>
        <p className="mt-6 max-w-3xl text-lg leading-8 text-white/55">
          Production traffic referenced an ILO factory absent from reachable Git history, and both known legacy
          factories embed compromised treasury provenance. New creation, token funding, contributions, whitelist
          changes, and finalisation are blocked. Lester Labs does not promise a token reward or sale allocation.
        </p>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <Link href="/launchpad" className="rounded-lg bg-[#6B4FFF] px-5 py-3 text-sm font-semibold">Open legacy recovery view</Link>
