  ...
  return (
    <main className="min-h-screen bg-[var(--bg)] px-6 py-28 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight sm:text-6xl">{writesActive ? 'Reviewed replacement swap candidate' : 'New swaps are temporarily unavailable'}</h1>
