...
const LITVM_TESTNET_ILO_FACTORY_ADDRESS = '0xA533bBe87bdCD91e4367de517e99bf8BA75Fd0aB'
const LITVM_TESTNET_TOKEN_FACTORY_ADDRESS = '0x93acc61fcdc2e3407A0c03450Adfd8aE78964948'
const LITVM_TESTNET_VESTING_FACTORY_ADDRESS = '0x6EE07118D39e9330Ef0658FFA797EeDD2CB823Cf'
const LITVM_TESTNET_LIQUIDITY_LOCKER_ADDRESS = '0x80d88C7F529D256e5e6A2CB0e0C30D82bC8827A9'
const LITVM_TESTNET_DISPERSE_ADDRESS = '0x3cc66cb4713dca78564df512922adb331ac5ee04'
const LITVM_TESTNET_LEDGER_ADDRESS = '0xa37fF4bAb59A5F861B48527A946C433dc1Ee8079'
...
export const ILO_FACTORY_ADDRESS = (process.env.NEXT_PUBLIC_ILO_FACTORY_ADDRESS || LITVM_TESTNET_ILO_FACTORY_ADDRESS) as `0x${string}`

export const TOKEN_FACTORY_ADDRESS = (process.env.NEXT_PUBLIC_TOKEN_FACTORY_ADDRESS || LITVM_TESTNET_TOKEN_FACTORY_ADDRESS) as `0x${string}`

export const VESTING_FACTORY_ADDRESS = (process.env.NEXT_PUBLIC_VESTING_FACTORY_ADDRESS || LITVM_TESTNET_VESTING_FACTORY_ADDRESS) as `0x${string}`

export const LIQUIDITY_LOCKER_ADDRESS = (process.env.NEXT_PUBLIC_LIQUIDITY_LOCKER_ADDRESS || LITVM_TESTNET_LIQUIDITY_LOCKER_ADDRESS) as `0x${string}`

export const DISPERSE_ADDRESS = (process.env.NEXT_PUBLIC_DISPERSE_ADDRESS || LITVM_TESTNET_DISPERSE_ADDRESS) as `0x${string}`

export const LEDGER_ADDRESS = (process.env.NEXT_PUBLIC_LEDGER_ADDRESS || LITVM_TESTNET_LEDGER_ADDRESS) as `0x${string}`
