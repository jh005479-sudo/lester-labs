...
export const UNISWAP_V2_FACTORY_ADDRESS = (process.env.NEXT_PUBLIC_UNISWAP_V2_FACTORY_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`

export const UNISWAP_V2_ROUTER_ADDRESS = (process.env.NEXT_PUBLIC_UNISWAP_V2_ROUTER_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`

export const WRAPPED_ZKLTC_ADDRESS = (process.env.NEXT_PUBLIC_WRAPPED_ZKLTC_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`
